...
int main(int argc, char *argv[])
{
  ...
  for(i = 0; i < nchan; i ++) // Prepare the scale
    {
      ...
      mean_scale_h[i].y = fabs((float)rand()/(float)(RAND_MAX/(float)MAX_RAND)) * 1000.0;
    }
  ...
  switch (blocksize_detect_faccumulate_scale.x)
    {
    case 1024:
      detect_faccumulate_scale_kernel2<1024><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 512:
      detect_faccumulate_scale_kernel2< 512><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 256:
      detect_faccumulate_scale_kernel2< 256><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 128:
      detect_faccumulate_scale_kernel2< 128><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 64:
      detect_faccumulate_scale_kernel2<  64><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 32:
      detect_faccumulate_scale_kernel2<  32><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 16:
      detect_faccumulate_scale_kernel2<  16><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 8:
      detect_faccumulate_scale_kernel2<   8><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 4:
      detect_faccumulate_scale_kernel2<   4><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 2:
      detect_faccumulate_scale_kernel2<   2><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
      
    case 1:
      detect_faccumulate_scale_kernel2<   1><<<gridsize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale, blocksize_detect_faccumulate_scale.x * NBYTE_RT>>>(g_in, g_out, nsamp, n_accumulate, mean_scale_d);
      break;
    }
  CHECK_LAUNCH_ERROR();
  ...
  /* Check the result */
  for(i = 0; i < nout; i++)
    fprintf(stdout, "CPU:\t%f\tGPU:\t%d\t%f\n", h_result[i], g_result[i], g_result[i] - h_result[i]);
