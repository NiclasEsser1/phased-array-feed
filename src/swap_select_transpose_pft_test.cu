...
// ./swap_select_transpose_pft_test -a 48 -b 1024 -c 1024
// ./swap_select_transpose_pft_test -a 33 -b 1024 -c 1024

extern "C" void usage ()
{
  fprintf (stdout,
	   "swap_select_transpose_pft_test - Test the swap_select_transpose_pft kernel \n"
	   "\n"
	   "Usage: swap_select_transpose_pft_test [options]\n"
...
int main(int argc, char *argv[])
{
  ...
  swap_select_transpose_pft_kernel<<<grid_size, block_size>>>(g_in, g_out, nsamp_in, nsamp_out, cufft_nx, cufft_mod, nchan_keep_chan);
