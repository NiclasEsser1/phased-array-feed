...
__global__ void transpose_scale_kernel(cufftComplex *dbuf_rt2, int8_t *dbuf_out, uint64_t offset_rt2, float *ddat_offs, float *ddat_scl);

/* Use for float data recording */
__global__ void transpose_float_kernel(cufftComplex *dbuf_rt2, float *dbuf_out, uint64_t offset_rt2);
