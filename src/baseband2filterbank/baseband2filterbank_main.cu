...
int main(int argc, char *argv[])
{
  ...
  runtime_log = multilog_open("baseband2filterbank", 1);
  multilog_add(runtime_log, fp_log);
  multilog(runtime_log, LOG_INFO, "START BASEBAND2FILTERBANK\n");
  ...
  multilog(runtime_log, LOG_INFO, "FINISH BASEBAND2FILTERBANK\n\n");
