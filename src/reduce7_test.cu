...
int main(int argc, char *argv[])
{
  ...
  switch (blocksize_reduce7.x)
    {
    case 1024:
      reduce7_kernel<1024><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 512:
      reduce7_kernel< 512><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 256:
      reduce7_kernel< 256><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 128:
      reduce7_kernel< 128><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 64:
      reduce7_kernel<  64><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 32:
      reduce7_kernel<  32><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 16:
      reduce7_kernel<  16><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 8:
      reduce7_kernel<   8><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 4:
      reduce7_kernel<   4><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
      
    case 2:
      reduce7_kernel<   2><<<gridsize_reduce7, blocksize_reduce7, blocksize_reduce7.x * NBYTE_RT>>>(g_in, g_out, len_in, n_accumulate, nstream);
      break;
