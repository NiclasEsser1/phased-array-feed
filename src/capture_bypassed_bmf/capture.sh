...
numactl -m 1 dada_db -k dada -l -p -b 1000000000 -n 1
sleep 2
# Reading client
echo "Connecting dada_dbdisk to dada buffer"
dada_dbdisk -k dada -b 1 -D /beegfsEDD/NESSER -W -d  # Problem is here: No errors thrown, but data aren't written to a file. Also tested with -D /beegfsEDD/NESSER/test.dada which throws "No such file or directory"
sleep 2
# Writing client for UDP capturing
echo "Starting capturing.."
dada_junkdb -k dada -b 1000000000 -r 1024 ../../config/header_16bit.txt
