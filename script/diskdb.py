...
# docker run --ipc=shareable --rm -it -v /beegfs:/beegfs -v /home/pulsar:/home/pulsar -u 50000:50000 --ulimit memlock=-1:-1 --name diskdb xinpingdeng/phased-array-feed "./diskdb.py -a ../config/pipeline.conf -b ../config/system.conf -c /beegfs/DENG/AUG/baseband/J1819-1458/J1819-1458.dada -d 0"
# docker run --ipc=shareable --rm -it -v /beegfs:/beegfs -v /home/pulsar:/home/pulsar -u 50000:50000 --ulimit memlock=-1:-1 --name diskdb xinpingdeng/phased-array-feed "./diskdb.py -a ../config/pipeline.conf -b ../config/system.conf -c /beegfs/DENG/AUG/baseband/J1713+0747/J1713+0747.dada -d 0"
# docker run --ipc=shareable --rm -it -v /beegfs:/beegfs -v /home/pulsar:/home/pulsar -u 50000:50000 --ulimit memlock=-1:-1 --name diskdb xinpingdeng/phased-array-feed "./diskdb.py -a ../config/pipeline.conf -b ../config/system.conf -c /beegfs/DENG/AUG/baseband/J1939+2134/J1939+2134.dada -d 0"
...
if __name__ == "__main__":
    ...
    diskdb = "dada_diskdb -k {:s} -f {:s} -o {:d} -s".format(key, fname, byte)
    print diskdb
    os.system(diskdb)    
