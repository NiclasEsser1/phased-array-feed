...
class pipelines:
    """
    A class to define the behaviour of pipelines
...
if __name__ == "__main__":
    ...
    pipeline = pipelines(system_conf, pipeline_conf, mode, nbeam, nchan, freq, utc_start, ip)
    #pipeline = pipelines(system_conf, pipeline_conf, mode, nbeam, nchan, freq)
