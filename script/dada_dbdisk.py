...
if __name__ == "__main__":
    ...
    com_line = "docker run --rm -it --ipc=container:{:s} -v {:s} -u {:d}:{:d} --name {:s} xinpingdeng/paf-base dada_dbdisk -k {:s} -D {:s}".format(previous_container_name, dvolume, uid, gid, current_container_name, key, directory)
